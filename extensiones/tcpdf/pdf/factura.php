...
$bloque1 = <<<EOF
	...
	<table>
		...
		<tr>
			...
			<td style="width:150px"><img src="images/car.png"></td>
...
$bloque2 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="border: 1px solid black; background-color:white; width:390px">

				Cliente: $respuestaCliente[nombre]

			</td>

			<td style="border: 1px solid black; background-color:white; width:150px; text-align:right">
		...
		<tr>
			...
			<td style="border: 1px solid black; background-color:white; width:540px">Vendedor: $respuestaVendedor[nombre]</td>
...
$bloque5 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="border-bottom: 1px solid black; background-color:white; width:100px; text-align:center"></td>

			<td style="border-bottom: 1px solid black; color:#333; background-color:white; width:100px; text-align:center"></td>
